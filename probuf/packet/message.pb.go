...
type GetMessageHistory struct {
	...
	MsgId string `protobuf:"bytes,1,opt,name=MsgId,proto3" json:"MsgId,omitempty"` //可以为空
}

func (x *GetMessageHistory) Reset() {
	*x = GetMessageHistory{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetMessageHistory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMessageHistory) ProtoMessage() {}

func (x *GetMessageHistory) ProtoReflect() protoreflect.Message {
	mi := &file_proto_message_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMessageHistory.ProtoReflect.Descriptor instead.
func (*GetMessageHistory) Descriptor() ([]byte, []int) {
	return file_proto_message_proto_rawDescGZIP(), []int{1}
}

func (x *GetMessageHistory) GetMsgId() string {
	if x != nil {
		return x.MsgId
	}
	return ""
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x23, 0x0a,
	...
	0x6e, 0x74, 0x22, 0x29, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x4d, 0x73, 0x67, 0x49, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x4d, 0x73, 0x67, 0x49, 0x64, 0x42, 0x0f, 0x5a,
	0x0d, 0x2e, 0x2f, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x3b, 0x70, 0x61, 0x63, 0x6b, 0x62, 0x06,
...
var file_proto_message_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: packet.Message
	(*GetMessageHistory)(nil), // 1: packet.GetMessageHistory
}
...
func file_proto_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetMessageHistory); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
